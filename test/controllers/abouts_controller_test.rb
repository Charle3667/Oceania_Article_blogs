...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference("About.count") do
      post abouts_url, params: { about: { first_name: @about.first_name, last_name: @about.last_name, profession: @about.profession, summary: @about.summary } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { first_name: @about.first_name, last_name: @about.last_name, profession: @about.profession, summary: @about.summary } }
